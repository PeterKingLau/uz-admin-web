<template>
    <el-table v-loading="loading" :data="data" v-bind="tableProps" @selection-change="onSelectionChange">
        <el-table-column v-for="col in columns" :key="col.prop || col.type || col.label" v-bind="getColumnProps(col)">
