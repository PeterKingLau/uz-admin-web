<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="info" plain @click="toggleExpandAll">
                    <el-icon><Icon icon="ep:sort" /></el-icon>
                    展开/折叠
                </el-button>
            </el-col>
        ...
        <!-- 添加或修改菜单对话框 -->
        <el-dialog :title="title" v-model="open" width="680px" append-to-body @close="handleDialogClose">
                ...
                <el-row>
                    ...
                    <el-col :span="12" v-if="form.menuType != 'F'">
                        <el-form-item label="菜单图标" prop="icon">
                            <el-popover placement="bottom-start" :width="540" v-model:visible="iconPopoverVisible" trigger="manual">
                                <template #reference>
                                    <el-input v-model="form.icon" placeholder="点击选择图标" readonly @click.stop="iconPopoverVisible = !iconPopoverVisible">
                                        <template #prefix>
                                            <Icon :icon="form.icon || 'ep:search'" class="el-input__icon" />
                                        </template>
                                    </el-input>
                                </template>
