<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="primary" plain @click="openSelectUser" v-hasPermi="['system:role:add']"><Icon icon="ep:plus"></Icon>添加用户</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button type="danger" plain :disabled="multiple" @click="cancelAuthUserAll" v-hasPermi="['system:role:remove']"
                    ><Icon icon="ep:circle-close"></Icon>批量取消授权</el-button
                >
            </el-col>
            <el-col :span="1.5">
                <el-button type="warning" plain @click="handleClose"><Icon icon="ep:close"></Icon>关闭</el-button>
            </el-col>
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template #default="scope">
                    <el-button link type="primary" @click="cancelAuthUser(scope.row)" v-hasPermi="['system:role:remove']"
                        ><Icon icon="ep:circle-close" />取消授权</el-button
                    >
                </template>
            </el-table-column>
        </el-table>
