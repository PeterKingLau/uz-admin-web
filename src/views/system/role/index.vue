<template>
    <div class="app-container system-crud-page system-role">
        ...
        <div class="table-wrapper">
            <div class="table-toolbar">
                <div class="left-tools">
                    <el-button type="primary" @click="handleAdd" v-hasPermi="['system:role:add']" class="tool-btn">
                        <Icon icon="ep:plus" class="btn-icon" />新增
                    </el-button>
                    <el-button
                        type="success"
                        :disabled="single || hasSuperAdmin"
                        @click="handleUpdate"
                    ...
                    <el-button
                        type="danger"
                        :disabled="multiple || hasSuperAdmin"
                        @click="handleDelete"
                    ...
                    <el-button type="warning" @click="handleExport" v-hasPermi="['system:role:export']" class="tool-btn">
            ...
            <!-- 表格数据 -->
            <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange" class="modern-table">
                ...
                <template #default="scope">
                    <div class="action-group">
                        <el-tooltip content="修改" placement="top" v-if="scope.row.roleId !== 1">
                            <el-button link type="primary" @click="handleUpdate(scope.row)" v-hasPermi="['system:role:edit']" class="op-btn">
                                <Icon icon="ep:edit" class="btn-icon" />
                            </el-button>
                        </el-tooltip>
                        <el-tooltip content="删除" placement="top" v-if="scope.row.roleId !== 1">
                            <el-button link type="danger" @click="handleDelete(scope.row)" v-hasPermi="['system:role:remove']" class="op-btn">
                                <Icon icon="ep:delete" class="btn-icon" />
                            </el-button>
                        </el-tooltip>
                        <el-tooltip content="数据权限" placement="top" v-if="scope.row.roleId !== 1">
                            <el-button link type="warning" @click="handleDataScope(scope.row)" v-hasPermi="['system:role:edit']" class="op-btn">
                                <Icon icon="ep:key" class="btn-icon" />
                            </el-button>
                        </el-tooltip>
                        <el-tooltip content="分配用户" placement="top" v-if="scope.row.roleId !== 1">
                            <el-button link type="success" @click="handleAuthUser(scope.row)" v-hasPermi="['system:role:edit']" class="op-btn">
        ...
        <!-- 添加或修改角色配置对话框 -->
        <el-dialog :title="title" v-model="open" width="600px" append-to-body class="role-dialog modern-dialog">
        ...
        <!-- 分配角色数据权限对话框 -->
        <el-dialog :title="title" v-model="openDataScope" width="500px" append-to-body class="modern-dialog">
            ...
            <template #footer>
                <div class="dialog-footer">
                    <el-button type="primary" @click="submitDataScope" class="dialog-btn">确 定</el-button>
                    <el-button @click="cancelDataScope" class="dialog-btn">取 消</el-button>
                </div>
            </template>
        </el-dialog>
    </div>
