            ...
            <el-scrollbar class="right-scrollbar">
                <el-form v-show="currentTab === 'field' && showField" size="default" label-width="90px" label-position="top">
                    ...
                    <template v-if="['el-checkbox-group', 'el-radio-group', 'el-select'].indexOf(activeData.tag) > -1">
                        ...
                        <VueDraggable v-model="activeData.options" :animation="340" group="selectItem" handle=".option-drag" item-key="label">
                        ...
                        <div>
                            <el-button style="margin-left: 8px; margin-top: 10px" text bg type="primary" @click="addSelectItem"> 添加选项 </el-button>
                        </div>
                        <el-divider />
                    </template>
                    ...
                    <template v-if="['el-cascader'].indexOf(activeData.tag) > -1">
                        ...
                        <div v-if="activeData.dataType === 'static'">
                            <el-button style="margin-left: 0; margin-top: 10px" type="primary" text bg @click="addTreeItem"> 添加父级 </el-button>
                        </div>
                        <el-divider />
                    </template>
                    ...
                    <template v-if="activeData.layout === 'colFormItem'">
                        ...
                        <div>
                            <el-button style="margin-left: 0; margin-top: 10px" type="primary" text bg @click="addReg"> 添加规则 </el-button>
                        </div>
                    </template>
                </el-form>
...
<script setup>
defineOptions({ name: 'ViewsToolBuildRightPanel' })
